...
abstract: "En las últimas décadas la literatura sobre desigualdad ha prestado mayor atención a las percepciones y preferencias de los ciudadanos en torno a ésta. Se ha planteado que la información factual sobre la desigualdad económica tiene un fuerte efecto sobre la justificación de desigualdad. Kriss Stella-Trump (2017) demostró que las individuos que poseen información sobre desigualdad salarial tienden a justificar mayores niveles de desigualdad económica. El presente estudio busca abordar esta hipótesis en el contexto chileno a través de un diseño experimental con encuestas. Para esto se emplearon datos de una muestra representativa del área metropolitana de Santiago de Chile (_n_=732). Los resultados muestran que la información factual sobre desigualdad salarial tiene un efecto en la justificación de una mayor brecha salarial entre ocupaciones bajo y alto estatus."

# "In recent decades, the literature on inequality has paid more attention to citizens' perceptions and preferences about inequality. Factual information about economic inequality has been posited to have a strong effect on inequality justification. Kriss Stella-Trump (2017) demonstrated that individuals who possess information about wage inequality tend to justify higher levels of economic inequality. The present study seeks to address this hypothesis in the Chilean context through an experimental design with surveys. For this purpose, data from a representative sample of the metropolitan area of Santiago de Chile (_n_=732) were used. The results show that factual information on wage inequality has an effect on the justification of a larger wage gap between low and high status occupations."  
---
...
Adicionalmente, utilizamos una condición que busca manipular lo que @Trump2017 denomina motivación hacia la justificación del sistema. Para ello, se presenta un párrafo que aborda las consecuencias a largo plazo de la reforma educacional llevada a cabo por el gobierno de turno, esto con el objetivo de contextualizar al participante en la cual su capacidad de agencia no posee influencia sobre los sucesos descritos en el texto. Dicho esto sostenemos que:
