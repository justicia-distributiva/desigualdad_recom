...
```{r variable selection, echo=FALSE, results='asis'}
...
```{r desigualdad-recomendada, echo=TRUE, message=FALSE, warning=FALSE}
...
ggsave("C:/Users/JC/Dropbox/Investigación Trump/presentacion-alas/barplot3.png", barplot2,units = "cm", width = 20,height = 15, dpi = "retina")
```
...
logOGcov4 <- lm(log_reco_OG~treat+ppol+log_perc_OG, data = st) #Grupo simultáneo | Log(Gerente/obrero) + cov
...
texreg::htmlreg(list(e1ad04,logOGcov1,e1bd04,logOGcov2,e2cd04,logOGcov3,logOGhc2))
