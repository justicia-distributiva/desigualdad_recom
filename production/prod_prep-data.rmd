...
```{r}
st.a <- st %>% select(COR,treat_a,reco_OG,log_reco_OG,log_perc_OG,zlog,just,ppol) %>% 
  filter(treat_a==1 | treat_a==0)  
st.b <- st %>% select(COR,treat_b,reco_OG,log_reco_OG,log_perc_OG,zlog,just,ppol) %>% 
  filter(treat_b==1 | treat_b==0)  
st.c <- st %>% select(COR,treat_c,reco_OG,log_reco_OG,log_perc_OG,zlog,just,ppol) %>% 
...
```{r}
st.a.sinout <- st_1 %>% select(COR,treat_a,saljusger,saljusobr,reco_OG,log_reco_OG,log_perc_OG,zlog,just,ppol) %>% 
  filter(treat_a==1 | treat_a==0)
st.b.sinout <- st_1 %>% select(COR,treat_b,saljusger,saljusobr,reco_OG,log_reco_OG,log_perc_OG,zlog,just,ppol) %>% 
  filter(treat_b==1 | treat_b==0)
st.c.sinout <- st_1 %>% select(COR,treat_c,saljusger,saljusobr,reco_OG,log_reco_OG,log_perc_OG,zlog,just,ppol) %>% 
  filter(treat_c==1 | treat_c==0)
```
